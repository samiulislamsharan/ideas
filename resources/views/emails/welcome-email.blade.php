                                        ...
                                        <div
                                            ...
                                            <h1
                                                ...
                                                <span class="font-sans-serif"
                                                    style="text-decoration: inherit;"><strong>Thank you for joining
                                                        &#129504; Ideas!</strong> {{ $user->name }}</span>
                                            </h1>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="vertical-align: middle;">
                                            ...
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Unleash your creativity and
                                                join the conversation on the ultimate platform for innovative minds!
                                                &#128161;&#10024; Whether you're here to share groundbreaking ideas,
                                                explore thought-provoking discussions, or connect with fellow
                                                visionaries, Ideas is the place where inspiration comes to life.</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&#127760; Dive into a world of
                                                limitless possibilities:</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&#10024; Share your thoughts
                                                in 280 characters or less.</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&#129309; Connect with
                                                like-minded individuals and build your network.</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&#127752; Explore trending
                                                ideas that spark your curiosity.</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&#128077; Give a thumbs up to
                                                the most brilliant concepts.</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&#128172; Engage in meaningful
                                                conversations that shape the future.</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 20px;">Ready to turn your ideas
                                                into reality? Let's create, collaborate, and inspire together on Ideas!
                                                &#128640; #WelcomeToIdeas #InnovationUnleashed</p>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="column js-footer-additional-info"
                                                    style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: sans-serif;width: 466px;">
                                                    <div
